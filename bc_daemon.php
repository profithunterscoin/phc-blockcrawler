...
require_once ("bc_walletconf.php");
...
{
//	The JSON-RPC request starts with a method name
	$request_array["method"] = "masternode";

	$request_array["params"][0] = "count";
...
function getmasternodedebug ()
{
//	The JSON-RPC request starts with a method name
	$request_array["method"] = "masternode";

	$request_array["params"][0] = "debug";
...
{
//	The JSON-RPC request starts with a method name
	$request_array["method"] = "masternodelist";

	$request_array["params"][0] = "full";
