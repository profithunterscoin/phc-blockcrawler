...
******************************************************************************/
	...
	function site_header ($title, $auth_list="")
	{
		...
		$NODE_WEBSITE = 'www.ProfitHuntersCoin.com';
		...
		if ($NODE_WEBSITE != "")
		{
			$optitle = $NODE_WEBSITE;
		}
	
		echo "	<title>".$title." ".$optitle."</title>\n\n";
		...
		echo "			<a href=\"".$_SERVER["PHP_SELF"]."\" title=\"Home Page\">\n";
		echo "				<img src=\"phc-med.png\">\n";
		echo "			</a>\n";
		echo "\n";

		if ($NODE_OPERATOR != "" && $NODE_WEBSITE != "")
		{
			echo '<p style="text-align: center;"><b>Operated by:</b><br> ' . $NODE_OPERATOR . '<br><a href="http://' . $NODE_WEBSITE . '" target="_blank">' . $NODE_WEBSITE . '</a></p>' . "\n";
		}
	...
	//	The page_wrap div is opened in the last line of the site_header function.	
		...
		echo "		PHC-BlockCrawler Script Modified By Biznatch Enterprises - PHC Donations: PNPPvrTgsyXSjtLgE9a9oL8MK8BZ68Ffrv<br>\n";
		echo "		BlockCrawler Script Created By Jake Paysnoe - BTC Donations: 1MoWrpf4DjLiL1ALtE6WAAPfHj1aZt38CE \n";
